      ...
      <ReactLenis root>
        ...
        <div id="hero" data-section="hero">
          <HeroBillboard
            ...
            marqueeItems={[
              ...
              { type: "text", text: "أحدث موديلات السيارات" },
              { type: "text", text: "خدمات موثوقة" },
              { type: "text", text: "استشارات خبيرة" },
        ...
        <div id="about" data-section="about">
          <MetricCardSeven
            ...
            metrics={[
              { id: "m1", value: "1000+", title: "عقار مباع", items: ["شقق سكنية", "فلل فاخرة", "أراضي تجارية"] },
              { id: "m2", value: "500+", title: "سيارة مباعة", items: ["سيارات حديثة", "سيارات اقتصادية", "سيارات دفع رباعي"] },
              { id: "m3", value: "24/7", title: "دعم فني", items: ["خدمة العملاء", "استشارات قانونية", "متابعة مستمرة"] },
            ]}
        ...
        <div id="metrics" data-section="metrics">
          <AboutMetric
            ...
            title="لماذا تختارنا؟"
            metrics={[
              { label: "مصداقية", value: "100%", icon: CheckCircle },
              { label: "خبرة", value: "15+ عام", icon: Award },
              { label: "انتشار", value: "جميع المحافظات", icon: MapPin },
            ]}
        ...
        <div id="faq" data-section="faq">
          <FaqDouble
            ...
            useInvertedBackground={true}
            faqs={[
              { id: "f1", title: "كيف يمكنني حجز عقار؟", content: "يمكنك التواصل معنا عبر الهاتف لحجز موعد للمعاينة." },
              { id: "f2", title: "هل يوجد تقسيط للسيارات؟", content: "نعم، نقدم حلول تمويلية مرنة للعديد من أنواع السيارات." },
              { id: "f3", title: "هل يمكن عرض عقاري لديكم؟", content: "بالتأكيد، يمكنكم إرسال تفاصيل العقار لنا لنقوم بتسويقه." },
            ]}
        ...
        <div id="contact" data-section="contact">
          <ContactCTA
            ...
            buttons={[{ text: "اتصل الآن", href: "tel:0997467230" }]}
          />
        </div>
        ...
        <div id="footer" data-section="footer">
          <FooterLogoReveal
            ...
            rightLink={{ text: "© 2024 جميع الحقوق محفوظة", href: "#" }}
          />
        </div>
      </ReactLenis>
    </ThemeProvider>
